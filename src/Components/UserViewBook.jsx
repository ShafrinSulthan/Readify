  ...
  const addToCart = async () => {
    try {
      ...
      const res = await axios.get(
        `http://https://readify-fdkn.onrender.com/books/cart?username=${loggedUser.username}&bookId=${book.id}`
      );
      ...
      if (res.data.length > 0) {
        ...
        await axios.patch(
          `http://https://readify-fdkn.onrender.com/books/cart/${existingItem.id}`,
          {
        ...
        await axios.post(
          "http://https://readify-fdkn.onrender.com/books/cart",
          cartItem
        );
      }
