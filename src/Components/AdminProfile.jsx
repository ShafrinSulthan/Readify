...
const AdminProfile = () => {
  ...
  const saveProfile = async () => {
    try {
      ...
      await axios.put(
        `http://https://readify-fdkn.onrender.com/books/users/${user.id}`,
        {
      ...
      <div className="card shadow p-4">
        ...
        <div className="row">
          ...
          <div className="col-md-6 mb-3">
            ...
            <label>Phone</label>
            <input className="form-control" name="phone" onChange={handleChange} disabled={!edit} />
          </div>
          <div className="col-md-6 mb-3">
            <label>Gender</label>
          ...
          <div className="row">
            ...
            <div className="col-md-6 mb-3">
              <label>Door No</label>
              <input className="form-control" name="doorNo" value={user.address.doorNo} onChange={handleAddressChange} disabled={!edit} />
            </div>
        ...
        <div className="mt-4 d-flex gap-3">
          ...
          {!edit ? (<button className="btn btn-primary" onClick={() => setEdit(true)}>Edit Profile</button>
          ) : (<>
